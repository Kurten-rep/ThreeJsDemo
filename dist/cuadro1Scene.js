...
export function createcuadro1Scene() {
    const goldVaseScene = new THREE.Scene();
    goldVaseScene.background = new THREE.Color(0x808080);

    const goldVaseLightLeft = new THREE.PointLight(0xffffff, 1, 100);
    const goldVaseLightRight = new THREE.PointLight(0xffffff, 1, 100);
    const goldVaseLightFront = new THREE.PointLight(0xffffff, 1, 100);
    const goldVaseLightBack = new THREE.PointLight(0xffffff, 1, 100);
    const goldVaseLightTop = new THREE.PointLight(0xffffff, 5, 100);
    const goldVaseLightBot = new THREE.PointLight(0xffffff, 5, 100);

    goldVaseLightLeft.position.set(10, 15, 0);
    ...
    loader.load('./Public/Models/Cuadro1.gltf', (gltf) => {
